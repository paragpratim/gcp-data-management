...
export default function CreateContract() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // ✅ Remove version from payload since it's auto-generated
      const { version, ...contractData } = contract;
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-section">
          ...
          <input 
            ...
            value={contract.data_product_name} 
          ...
          <input 
            type="text" 
            name="version" 
            placeholder="Version (Auto-generated)" 
            value={contract.version} 
            onChange={handleChange}
            disabled={true} // ✅ Make field uneditable
            style={{ 
              backgroundColor: '#f5f5f5', 
              cursor: 'not-allowed',
              color: '#888'
            }}
            title="Version will be automatically generated by the system"
          />
          <input 
            type="text" 
            name="data_owner" 
            placeholder="Data Owner" 
            value={contract.data_owner} 
            onChange={handleChange} 
            required 
          />
          <textarea
